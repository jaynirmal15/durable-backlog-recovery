...
| 33. T1 vs Table 1 | `figures/T1-false-findings.md` (`make_table1.py`) is the manuscript's **Table 2**; its **Table 1** has no generated artefact and lives in `paper/section4.md`. **Rename at the W5 figure pass** |
